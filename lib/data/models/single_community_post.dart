...
class SingleCommunityPost extends Equatable {
  final int id;
  final User author;
  final int upvotes;
  final int downvotes;
  ...
  factory SingleCommunityPost.fromJson(String source) =>
      SingleCommunityPost.fromMap(json.decode(source) as Map<String, dynamic>);
