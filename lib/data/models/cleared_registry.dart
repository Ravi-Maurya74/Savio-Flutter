...
class ClearedRegistry {
  ...
  factory ClearedRegistry.fromMap(Map<String, dynamic> map) {
    return ClearedRegistry(
  ...
  factory ClearedRegistry.fromJson(String source) => ClearedRegistry.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'ClearedRegistry(id: $id, lender: $lender, borrower: $borrower, initiated_by: $initiated_by, cleared_by: $cleared_by, amount: $amount, create_date: $create_date, clear_date: $clear_date, status: $status, description: $description)';
  }

  @override
  bool operator ==(covariant ClearedRegistry other) {
